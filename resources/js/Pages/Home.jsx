        ...
        <div className="p-4 sm:p-6 lg:p-7 ">
          ...
          >
                  ...
                  <div className="w-full flex flex-col items-center justify-center relative">
                    <Avatar>
                      {apiData && apiData.data2 ? (
                        <AvatarImage
                          src={
                            "https://ddragon.leagueoflegends.com/cdn/14.11.1/img/profileicon/" + apiData.data2.profileIconId + ".png"
                          }
                        />
                      ) : (
                ...
                <div className="w-full pb-4 flex flex-col items-center justify-center gap-2">
                  ...
                  </h1>
                  {
                    apiData?.data3?.map((data) => (
                      <div className="w-full p-5 flex flex-col gap-2 " key={data.id}>
                        <div className="flex items-center gap-2 bg">
                          <img className={data.tier ? 'h-32' : 'hidden'} src={`/RankedEmblemsLatest/Rank=${data.tier}.png`} alt="Rank Emblem" />
            ...
            <div className="flex flex-col gap-4 w-full col-span-3">
                  ...
                  {MatchIds &&
                    MatchIds?.map((data) => {
                      ...
                      const selectedPlayerInfo = data.info.participants.find(
                        (participant) => {
                          return participant.puuid === localStorage.getItem('searchedUserPUUID');
                        }
                      );
                            ...
                            <CollapsibleTrigger className="w-full">
                              <div className="flex flex-col gap-4">
                                <div className="flex  justify-between">
                                  ...
                                  <TooltipProvider>
                                    <Tooltip>
                                      <TooltipTrigger><p>{formatTimeAgo(data.info.gameStartTimestamp)}</p></TooltipTrigger>
                                      <TooltipContent>
                                        <p>{formatLocaleDateTime(data.info.gameStartTimestamp)}</p>
                                      </TooltipContent>
                                    </Tooltip>
                                  </TooltipProvider>
                                  {hours > 0 && (
                                ...
                                <div className="w-full h-26 flex flex-col items-left gap-2">
                                  <p className="text-white font-bold text-left">{selectedPlayerInfo?.riotIdGameName}</p>
                                  <div className="flex flex-wrap gap-2">
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item0 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item0}.png` : `/EmptyBox.png`} alt="item0" />
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item1 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item1}.png` : `/EmptyBox.png`} alt="item1" />
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item2 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item2}.png` : `/EmptyBox.png`} alt="item2" />
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item3 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item3}.png` : `/EmptyBox.png`} alt="item3" />
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item4 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item4}.png` : `/EmptyBox.png`} alt="item4" />
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item5 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item5}.png` : `/EmptyBox.png`} alt="item5" />
                                    <img className="h-6 w-6" src={selectedPlayerInfo?.item6 != 0 ? `https://ddragon.leagueoflegends.com/cdn/14.11.1/img/item/${selectedPlayerInfo?.item6}.png` : `/EmptyBox.png`} alt="item6" />
                                  ...
                                  <div className="flex flex-col w-1/2 gap-2">
                                    ...
                                    {data.info.participants.map((participant) => {
                                      ...
                                      if (participant.teamId === team.teamId) {
                                        const searchedUserPUUID = localStorage.getItem('searchedUserPUUID');
                                        ...
                                        return (
                                          <div className="flex gap-2">
                                            ...
                                            <div className="flex flex-col gap-1">
                                              <h1 className={participant.puuid == searchedUserPUUID ? 'font-bold text-white' : ''}>{`${participant.riotIdGameName}#${participant.riotIdTagline}` || participant.championName}</h1>
                                              <h1>
              ...
              <Button onClick={() => {
                fetchMoreMatchIds()
              }} className={MatchIds && MatchIds.length == 0 ? 'hidden' : 'p-4 bg-[#1A1A22]'}><p className="w-full text-center">Load more</p></Button>
            </div>
          </div>
